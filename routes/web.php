...
Route::group(['middleware' => 'userlogin'], function () {
    ...
    Route::middleware(['checkRoleUser:/supplier,menu'])->group(function () {
        ...
        Route::get('/admin/supplier/show/', [CustomerController::class, 'show'])->name('supplier.getsupplier');
        Route::post('/admin/supplier/proses_tambah/', [CustomerController::class, 'proses_tambah'])->name('supplier.store');
    ...
    Route::middleware(['checkRoleUser:/lap-barang-keluar,submenu'])->group(function () {
        ...
        Route::get('/admin/lapbarangkeluar/surat/', [LapBarangKeluarController::class, 'surat'])->name('lap-bk.surat');
